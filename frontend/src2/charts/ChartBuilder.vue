...
<template>
	<div class="relative flex h-full w-full overflow-hidden">
		...
		>
			<CollapsibleSection title="Діаграма">
				<div class="flex flex-col gap-3">
					<ChartTypeSelector v-model="chart.doc.chart_type" />
					<ChartQuerySelector v-model="chart.doc.query" :queries="props.queries" />
					<InlineFormControlLabel label="Назва">
						<LazyTextInput type="text" placeholder="Назва" v-model="chart.doc.title" />
			...
			<CollapsibleSection title="Фільтри" collapsed>
			...
			<CollapsibleSection title="Сортування" collapsed>
			...
			<CollapsibleSection title="Ліміт" collapsed>
