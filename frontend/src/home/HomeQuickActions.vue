<template>
	<div>
		<div class="flex items-center space-x-2">
			...
			<div class="text-lg">{{ __('Quick Actions') }}</div>
		</div>
		<div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
			...
			>
				<div class="text-lg font-medium text-gray-900">{{ __('Connect Data Source') }}</div>
				<div class="rounded bg-gray-100 p-1">
			...
			>
				<div class="text-lg font-medium text-gray-900">{{ __('Create a Query') }}</div>
				<div class="rounded bg-gray-100 p-1">
					<FeatherIcon name="plus" class="h-4 w-4 text-gray-900" />
				</div>
			</div>
			...
			>
				<div class="text-lg font-medium text-gray-900">{{ __('Create a Dashboard') }}</div>
				<div class="rounded bg-gray-100 p-1">
					<FeatherIcon name="plus" class="h-4 w-4 text-gray-900" />
				</div>
			</div>
