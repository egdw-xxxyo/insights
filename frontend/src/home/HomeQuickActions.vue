<template>
	<div>
		...
		<div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
			...
			>
				<div class="text-lg font-medium text-gray-900">З'єднати джерело даних</div>
				<div class="rounded bg-gray-100 p-1">
			...
			>
				<div class="text-lg font-medium text-gray-900">Створити запит</div>
				<div class="rounded bg-gray-100 p-1">
					<FeatherIcon name="plus" class="h-4 w-4 text-gray-900" />
				</div>
			</div>
			...
			>
				<div class="text-lg font-medium text-gray-900">Створити дашборд</div>
				<div class="rounded bg-gray-100 p-1">
					<FeatherIcon name="plus" class="h-4 w-4 text-gray-900" />
				</div>
			</div>
